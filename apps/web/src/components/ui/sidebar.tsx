  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          'fixed bottom-0 z-10 hidden w-(--sidebar-width) transition-[left,right,width,top] duration-200 ease-linear md:flex',
          'top-(--impersonation-offset,0)',
          side === 'left'
            ? 'left-0 group-data-[collapsible=offcanvas]:left-[calc(var(--sidebar-width)*-1)]'
            : 'right-0 group-data-[collapsible=offcanvas]:right-[calc(var(--sidebar-width)*-1)]',
          // Adjust the padding for floating and inset variants.
          // Symmetric padding when collapsed for centered island appearance
          'p-4 pr-0 group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)+(--spacing(4)))] group-data-[collapsible=icon]:p-2',
          className
        )}
        {...props}
      >
...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        'text-sidebar-foreground/40 ring-sidebar-ring flex h-8 shrink-0 items-center rounded-md px-3 text-[11px] font-medium tracking-wide uppercase outline-hidden transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0',
...
// Predefined widths for skeleton variation (avoids impure Math.random during render)
const SKELETON_WIDTHS = ['50%', '60%', '70%', '80%', '90%', '55%', '65%', '75%', '85%'] as const;
...
function SidebarMenuSkeleton({
  ...
  // Cycle through predefined widths for visual variety
