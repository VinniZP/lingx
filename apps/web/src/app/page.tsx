    ...
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <section className="relative pt-28 pb-16 lg:pt-36 lg:pb-24">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-0 left-1/4 w-[600px] h-[600px] rounded-full bg-linear-to-br from-primary/20 to-transparent blur-3xl animate-pulse-slow" />
          <div className="absolute top-1/4 right-1/4 w-[500px] h-[500px] rounded-full bg-linear-to-br from-warm/15 to-transparent blur-3xl animate-pulse-slower" />
          <div className="absolute bottom-0 left-1/3 w-[400px] h-[400px] rounded-full bg-linear-to-br from-emerald-500/10 to-transparent blur-3xl animate-pulse-slow" />
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          <div className="max-w-3xl mx-auto text-center space-y-6 mb-16">
            ...
            >
              {t('landing.headline')}
              <br />
              <span className="bg-linear-to-r from-primary via-primary to-warm bg-clip-text text-transparent">
      ...
      <section className="py-20 lg:py-32">
        <div className="max-w-7xl mx-auto px-6">
          <div className="relative island overflow-hidden bg-linear-to-br from-sidebar to-sidebar/95">
            ...
            <div className="relative px-8 py-16 lg:px-16 lg:py-24 text-center">
              <div className="max-w-2xl mx-auto space-y-6">
                ...
                >
                  {t('landing.cta.title')}
                  <br />
                  <span className="bg-linear-to-r from-warm to-primary bg-clip-text text-transparent">
      ...
      <footer className="border-t border-border py-16 lg:py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 lg:gap-12 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-muted-foreground">
                <li><Link href="https://github.com/VinniZP/lingx" className="hover:text-foreground transition-colors">{t('landing.footer.github')}</Link></li>
                <li><Link href="https://github.com/VinniZP/lingx/issues" className="hover:text-foreground transition-colors">{t('landing.footer.issues')}</Link></li>
                <li><Link href="https://github.com/VinniZP/lingx/discussions" className="hover:text-foreground transition-colors">{t('landing.footer.discussions')}</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-muted-foreground">
                ...
                <li><Link href="https://github.com/VinniZP/lingx#readme" className="hover:text-foreground transition-colors">{t('landing.footer.readme')}</Link></li>
                <li><Link href="https://github.com/VinniZP/lingx/blob/main/CONTRIBUTING.md" className="hover:text-foreground transition-colors">{t('landing.footer.contributing')}</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-muted-foreground">
                <li><Link href="https://github.com/VinniZP/lingx/blob/main/LICENSE" className="hover:text-foreground transition-colors">{t('landing.footer.mitLicense')}</Link></li>
              </ul>
            </div>
          </div>
          ...
          <div className="pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4">
              <Link href="https://github.com/lingx" className="text-muted-foreground hover:text-foreground transition-colors">
                <svg className="size-5" fill="currentColor" viewBox="0 0 24 24">
                  <path fillRule="evenodd" d="M12 2C6.477 2 2 6.484 2 12.017c0 4.425 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483 0-.237-.008-.868-.013-1.703-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.531 1.032 1.531 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.988 1.029-2.688-.103-.253-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.026A9.564 9.564 0 0112 6.844c.85.004 1.705.115 2.504.337 1.909-1.296 2.747-1.027 2.747-1.027.546 1.379.202 2.398.1 2.651.64.7 1.028 1.595 1.028 2.688 0 3.848-2.339 4.695-4.566 4.943.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.58.688.482A10.019 10.019 0 0022 12.017C22 6.484 17.522 2 12 2z" clipRule="evenodd" />
                </svg>
              </Link>
              <Link href="https://twitter.com/lingx" className="text-muted-foreground hover:text-foreground transition-colors">
                <svg className="size-5" fill="currentColor" viewBox="0 0 24 24">
