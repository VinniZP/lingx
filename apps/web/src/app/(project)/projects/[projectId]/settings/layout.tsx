      ...
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="flex flex-col items-center gap-6">
          <div className="relative">
            <div className="size-16 rounded-2xl bg-gradient-to-br from-primary/20 to-primary/5 animate-pulse" />
          ...
          <div className="flex items-start gap-6">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-3 mb-1">
                <div className="size-11 rounded-xl bg-gradient-to-br from-primary/15 to-primary/5 border border-primary/10 flex items-center justify-center shadow-sm">
        ...
        <div className="flex gap-8">
          ...
          <div className="w-64 shrink-0">
            <nav className="sticky top-8 space-y-6">
              ...
              {/* Divider */}
              <div className="h-px bg-gradient-to-r from-border/60 via-border/30 to-transparent mx-3" />
